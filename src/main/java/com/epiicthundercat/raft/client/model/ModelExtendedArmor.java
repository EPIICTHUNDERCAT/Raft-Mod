 ...
 *
 * Original:
 * https://github.com/Darkhax-Minecraft/Bookshelf/blob/master/src/main/java/net/darkhax/bookshelf/client/model/ModelExtendedArmor.java
 *
 * Changes: - Backdated to 1.10.2
 *******************************************************************************************************************/

@SideOnly(Side.CLIENT)
public abstract class ModelExtendedArmor extends ModelBiped {
	 ...
	 *
	 * @param entity
	 *            The entity to sync the model with.
	 * @param partialTicks
	 *            The partial ticks.
	 */
	protected void syncModel(Entity entity, float partialTicks) {
	 ...
	 * @param z
	 *            The rotation angle on the Z exis.
	 */
	...
	public void render(Entity entity, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw,
		...
		GlStateManager.translate(-0.63F, -0.19F, -0.45F);
