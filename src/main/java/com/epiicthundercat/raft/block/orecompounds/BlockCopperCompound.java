...
public class BlockCopperCompound extends RBlock implements IPlantable {
	public static final EnumPlantType COPPER = EnumPlantType.getPlantType("Copper");
	protected static final AxisAlignedBB COPPER_AABB = new AxisAlignedBB(0.125D, 0.0D, 0.125D, 0.875D, 1.0D, 0.875D);

	public BlockCopperCompound(String name, Material material, float hardness) {
	...
	public void onBlockHarvested(World worldIn, BlockPos pos, IBlockState state, EntityPlayer player) {
		this.spawnAsEntity(worldIn, pos, new ItemStack(RItems.copper_compound));
