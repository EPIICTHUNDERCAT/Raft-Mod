...
public class BlockNickelCompound extends RBlock implements IPlantable {
	public static final EnumPlantType NICKEL = EnumPlantType.getPlantType("Nickel");
	protected static final AxisAlignedBB NICKEL_AABB = new AxisAlignedBB(0.125D, 0.0D, 0.125D, 0.875D, 1.0D, 0.875D);

	public BlockNickelCompound(String name, Material material, float hardness) {
	...
	public void onBlockHarvested(World worldIn, BlockPos pos, IBlockState state, EntityPlayer player) {
		this.spawnAsEntity(worldIn, pos, new ItemStack(RItems.nickel_compound));
