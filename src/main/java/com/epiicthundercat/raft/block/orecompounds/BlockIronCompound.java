...
public class BlockIronCompound extends RBlock implements IPlantable {
	public static final EnumPlantType IRON = EnumPlantType.getPlantType("Iron");
	protected static final AxisAlignedBB IRON_AABB = new AxisAlignedBB(0.125D, 0.0D, 0.125D, 0.875D, 1.0D, 0.875D);

	public BlockIronCompound(String name, Material material, float hardness) {
	...
	public void onBlockHarvested(World worldIn, BlockPos pos, IBlockState state, EntityPlayer player) {
		this.spawnAsEntity(worldIn, pos, new ItemStack(RItems.iron_compound));
