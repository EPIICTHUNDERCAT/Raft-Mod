...
public class BlockSilverCompound extends RBlock implements IPlantable {
	public static final EnumPlantType SILVER = EnumPlantType.getPlantType("Silver");
	protected static final AxisAlignedBB SILVER_AABB = new AxisAlignedBB(0.125D, 0.0D, 0.125D, 0.875D, 1.0D, 0.875D);

	public BlockSilverCompound(String name, Material material, float hardness) {
	...
	public void onBlockHarvested(World worldIn, BlockPos pos, IBlockState state, EntityPlayer player) {
		this.spawnAsEntity(worldIn, pos, new ItemStack(RItems.silver_compound));
