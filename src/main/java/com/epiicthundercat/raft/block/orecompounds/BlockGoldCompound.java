...
public class BlockGoldCompound extends RBlock implements IPlantable {
	public static final EnumPlantType Gold = EnumPlantType.getPlantType("Gold");
	protected static final AxisAlignedBB Gold_AABB = new AxisAlignedBB(0.125D, 0.0D, 0.125D, 0.875D, 1.0D, 0.875D);

	public BlockGoldCompound(String name, Material material, float hardness) {
	...
	public void onBlockHarvested(World worldIn, BlockPos pos, IBlockState state, EntityPlayer player) {
		this.spawnAsEntity(worldIn, pos, new ItemStack(RItems.gold_compound));
