...
public class BlockUraniumCompound extends RBlock implements IPlantable {
	public static final EnumPlantType URANIUM = EnumPlantType.getPlantType("Uranium");
	protected static final AxisAlignedBB URANIUM_AABB = new AxisAlignedBB(0.125D, 0.0D, 0.125D, 0.875D, 1.0D, 0.875D);

	public BlockUraniumCompound(String name, Material material, float hardness) {
	...
	public void onBlockHarvested(World worldIn, BlockPos pos, IBlockState state, EntityPlayer player) {
		this.spawnAsEntity(worldIn, pos, new ItemStack(RItems.uranium_compound));
