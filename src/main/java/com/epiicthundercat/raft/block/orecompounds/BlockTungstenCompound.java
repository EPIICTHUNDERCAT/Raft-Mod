...
public class BlockTungstenCompound extends RBlock implements IPlantable {
    public static final EnumPlantType TUNGSTEN = EnumPlantType.getPlantType("Tungsten");
   protected static final AxisAlignedBB TUNGSTEN_AABB = new AxisAlignedBB(0.125D, 0.0D, 0.125D, 0.875D, 1.0D, 0.875D);

    public BlockTungstenCompound(String name, Material material, float hardness) {
    ...
    {
    	this.spawnAsEntity(worldIn, pos, new ItemStack(RItems.tungsten_compound));
