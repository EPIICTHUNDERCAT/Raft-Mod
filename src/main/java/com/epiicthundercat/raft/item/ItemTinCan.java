...
public class ItemTinCan extends RItem
{
    ...
    public ActionResult<ItemStack> onItemRightClick(ItemStack itemStackIn, World worldIn, EntityPlayer playerIn, EnumHand hand)
    {
        ...
        if (!list.isEmpty())
        {
            ...
            return new ActionResult(EnumActionResult.SUCCESS, this.turnTinCanIntoItem(itemStackIn, playerIn, new ItemStack(Items.DRAGON_BREATH)));
        }
            ...
            else
            {
                if (raytraceresult.typeOfHit == RayTraceResult.Type.BLOCK)
                {
                    ...
                    if (worldIn.getBlockState(blockpos).getMaterial() == Material.WATER)
                    {
                        ...
                        return new ActionResult(EnumActionResult.SUCCESS, this.turnTinCanIntoItem(itemStackIn, playerIn, new ItemStack(RItems.tin_can_dirty)));
                    }
                }
    ...
    protected ItemStack turnTinCanIntoItem(ItemStack p_185061_1_, EntityPlayer player, ItemStack stack)
    {
