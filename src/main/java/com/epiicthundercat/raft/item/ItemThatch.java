...
public class ItemThatch extends RItem{
	

    public ItemThatch(String name)
    {
    	super(name);
    ...
    public ActionResult<ItemStack> onItemRightClick(World worldIn, EntityPlayer playerIn, EnumHand handIn)
    {
        ...
        else
        {
            ...
            else
            {
                ...
                ThatchEntity ThatchEntity = new ThatchEntity(worldIn, raytraceresult.hitVec.xCoord, flag1 ? raytraceresult.hitVec.yCoord - 0.12D : raytraceresult.hitVec.yCoord, raytraceresult.hitVec.zCoord);
                
                ThatchEntity.rotationYaw = playerIn.rotationYaw;

                if (!worldIn.getCollisionBoxes(ThatchEntity, ThatchEntity.getEntityBoundingBox().expandXyz(-0.1D)).isEmpty())
                {
