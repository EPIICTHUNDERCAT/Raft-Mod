	...
	public ActionResult<ItemStack> onItemRightClick(World worldIn, EntityPlayer playerIn, EnumHand handIn) {
		...
		if (raytraceresult == null) {
			...
			if (flag) {
				...
				ScrapEntity ScrapEntity = new ScrapEntity(worldIn, raytraceresult.hitVec.xCoord,
				...
				if (!worldIn.getCollisionBoxes(ScrapEntity, ScrapEntity.getEntityBoundingBox().expandXyz(-0.1D))
						.isEmpty()) {
