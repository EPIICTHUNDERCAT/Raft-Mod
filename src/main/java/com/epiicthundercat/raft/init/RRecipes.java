...
public class RRecipes {
	...
	public static void register(FMLPreInitializationEvent preEvent) {
		...
		RecipeHandler.addSeparatorSeperateRecipe(RItems.scrap, new ItemStack(RItems.aluminium_compound),
		...
		OreDictionary.registerOre("ingotAluminium", new ItemStack(RItems.aluminium_ingot));
